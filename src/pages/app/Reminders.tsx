...
import { useFocusTimer, presets, TimerPhase } from "@/contexts/FocusTimerContext";
...
const Reminders = () => {
  ...
  // Show exercise recommendation when REST phase just completed (transitioned to WORK)
  useEffect(() => {
    if (previousPhaseRef.current === "rest" && currentPhase === "work" && timeRemaining > 0) {
      // Just transitioned from REST to WORK - show exercise recommendation
